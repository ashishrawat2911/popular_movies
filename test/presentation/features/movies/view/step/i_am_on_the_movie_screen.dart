...
Future<void> iAmOnTheMovieScreen(WidgetTester tester) async {
  await GetIt.I.reset();
  final mockGetMoviesUseCase = MockGetMoviesUseCase();
  GetIt.I.registerSingleton<GetMoviesUseCase>(mockGetMoviesUseCase);
